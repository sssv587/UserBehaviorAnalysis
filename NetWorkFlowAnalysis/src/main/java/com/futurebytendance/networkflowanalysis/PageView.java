...
public class PageView {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple2<String, Long>> pvResultStream0 = dataStream.filter((FilterFunction<UserBehavior>) value -> "pv".equals(value.getBehavior()))
        ...
        SingleOutputStreamOperator<PageViewCount> pvStream = dataStream.filter((FilterFunction<UserBehavior>) value -> "pv".equals(value.getBehavior()))
